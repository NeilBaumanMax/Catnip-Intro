...
const cooperation = [
  { text: '学校资料管理 Agent', size: 'text-lg', color: 'text-white', delay: '0s' },
  { text: '企业本地知识库', size: 'text-2xl', color: 'text-white', delay: '0.2s' },
  { text: 'OPC 智能员工盒子', size: 'text-sm', color: 'text-white', delay: '0.4s' },
  { text: '端侧 AI 控制主板', size: 'text-xl', color: 'text-white', delay: '0.1s' },
  { text: '智能硬件定制开发', size: 'text-base', color: 'text-white', delay: '0.5s' },
  { text: '工业设备智能控制', size: 'text-3xl', color: 'text-white', delay: '0.3s' },
  { text: 'Agent Runtime', size: 'text-lg', color: 'text-white', delay: '0.15s' },
  { text: '私有化部署', size: 'text-xl', color: 'text-white', delay: '0.35s' },
  { text: '本地 Agent 智能板卡', size: 'text-2xl', color: 'text-white', delay: '0.25s' },
  { text: '文档处理与流程自动化', size: 'text-base', color: 'text-white', delay: '0.45s' },
  { text: '软硬件一体化', size: 'text-3xl', color: 'text-white', delay: '0.05s' },
  { text: '端侧大模型部署', size: 'text-lg', color: 'text-white', delay: '0.55s' },
  { text: '创客教育', size: 'text-sm', color: 'text-white', delay: '0.6s' },
  { text: '机器人控制', size: 'text-base', color: 'text-white', delay: '0.3s' },
  { text: '智能办公', size: 'text-xl', color: 'text-white', delay: '0.7s' },
]
                ...
                {cooperation.map((item) => (
                  <span
                    ...
                    className={`${item.size} ${item.color} font-bold px-4 py-2 rounded-full cursor-default
                      animate-[wordPulse_3s_ease-in-out_infinite] hover:scale-125 hover:bg-white/20 transition-all duration-300

...
全站功能完整，后台 6 页面 + 前台 7 页面，玻璃风格视觉。已部署至腾讯云 CVM (118.195.247.102)，Nginx :80 反向代理，Go SSE 轮播。
...
- 图片优化 ✅ (3-6MB PNG → 9-27KB JPEG, 99% 压缩, ImageMagick)
- 腾讯云部署 ✅ (Ubuntu 22.04, Go 1.25, Node v22, Nginx :80)
- SSE 轮播修复 ✅ (Nginx Content-Type 透传, 纯后端计时器)
- Nginx 反向代理 ✅ (118.195.247.102)
